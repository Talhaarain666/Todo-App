...
import { getDatabase, ref, push, set, onValue, remove } from "https://www.gstatic.com/firebasejs/9.6.4/firebase-database.js";
...
window.renderArr = function () {
    ...
    window.editNote = function (elemid) {
        ...
        const updates = {};
        updates['/posts/' + elemid] = postData;
        updates['/user-posts/' + elemid + '/' + elemid] = postData;
